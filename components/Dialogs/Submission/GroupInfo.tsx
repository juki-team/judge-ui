...
import { Memory, Time, Verdict } from '../../Submissions';
...
export const GroupInfo = ({ groupKey, isSubtaskProblem, timeUsed, memoryUsed, verdict, points, testCases }: GroupInfoProps) => {
  return (
    <Collapse
